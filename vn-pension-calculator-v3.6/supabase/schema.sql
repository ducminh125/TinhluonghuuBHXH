-- VN Pension Calculator v3.1 - Supabase schema
-- Run in Supabase SQL Editor once. Auth providers used by this build: Email and Google.
-- Admin access is promoted server-side when the signed-in email is listed in Vercel ADMIN_EMAILS.
